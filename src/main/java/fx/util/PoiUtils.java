...
public class PoiUtils {
     ...
     * @return
     */
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations, List<Politicsstatus> allPoliticsstatus, List<Department> allDepartment, List<Position> allPosition, List<JobLevel> allJobLevels) {
    ...
    public ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        //1.创建一个excel文档
        ...
        //把workbook转成byte数组：把workbook写到输出流里面再把它转成字节数组
